...
docker cp nginx:/rootfs.tar . && docker build -t lbbniu/nginx . && docker run -ti --rm -v /data:/data lbbniu/nginx
...
docker cp php5:/rootfs.tar . && docker build -t lbbniu/php5 . && docker run -ti --rm lbbniu/php5
=======================
...
docker cp php7:/rootfs.tar . && docker build -t lbbniu/php7 . && docker run -ti --rm lbbniu/php7
=======================
