...
php7
apt-get install -y libxml2-dev libmcrypt-dev libcurl4-gnutls-dev libjpeg-dev libpng-dev libxpm-dev libfreetype6-dev  libcurl3-openssl-dev autoconf libxslt1-dev  libmysql++-dev
